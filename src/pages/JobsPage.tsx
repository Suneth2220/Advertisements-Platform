          ...
          {filteredJobs.map((job) => (
            <div key={job.id} className="bg-white rounded-xl shadow-lg p-6 hover:shadow-xl transition-shadow">
              ...
              <div className="flex flex-col sm:flex-row gap-3">
                ...
                <Link to={`/jobs/${job.id}`} className="border border-blue-600 text-blue-600 px-6 py-2 rounded-lg hover:bg-blue-50 transition-colors font-semibold inline-flex items-center justify-center">
                  View Details
                </Link>
              </div>
            </div>
